<%@ Page Language="C#" Inherits="Forum.Business.MyThreadEditPage, Forum.Business" AutoEventWireup="true" MasterPageFile="~/ControlPanelThemes/Default/Masters/ControlPanelIFrameContentMaster.master" %>
...
<!--
    ...
    function RedirectToManageList(myopenthreadurl)
    {
        self.location = myopenthreadurl;
    }
