<%@ Page Language="C#" Inherits="Forum.Business.SectionAddPage, Forum.Business" AutoEventWireup="true" MasterPageFile="~/ControlPanelThemes/Default/Masters/ControlPanelIFrameContentMaster.master" %>
...
<div class="AdminArea">
    <fieldset>
        <legend><ctrl:ResourceLiteral ID="ResourceLiteral1" runat="server" ResourceName="System_ControlPanel_Section_AddControlTitle" ResourceFile="ControlPanelResources.xml" /></legend>
        <div class="FormRow">
            <ctrl:ResourceLabel ID="ResourceLabel1" CssClass="FieldName" runat="Server" ResourceFile="ControlPanelResources.xml" ResourceName="System_ControlPanel_Section_SelectGroup" />
            <ctrl:ValuedDropDownList ID="groupDropDownList" runat="server" Width="150px" />
        </div>
        <div class="FormRow">
            <ctrl:ResourceLabel ID="ResourceLabel2" CssClass="FieldName" runat="Server" ResourceFile="ControlPanelResources.xml" ResourceName="System_ControlPanel_Section_Subject" />
